...
public class BucketbotDriver extends BucketbotBase {
	...
	public BucketbotDriver(float bucketbot_radius, float bucket_pickup_setdown_time, float bucketbot_max_acceleration, float bucketbot_max_velocity, float collision_penalty_time) 
	{
