...
public class SimulationWorldMarketTaskAllocation extends SimulationWorld {
	...
	public SimulationWorldMarketTaskAllocation() 
	{
		...
		{
			letterStationAgents.add(i, new LetterStationAgent(station_size, letter_to_bucket_time, bundle_size, letter_station_capacity));
		...
		{
			wordStationAgents.add(i, new WordStationAgent(station_size, bucket_to_letter_time, word_completion_time, word_station_capacity) );
		...
		for(Updateable a : bucketbotAgents) updateables.add(a);
		for(Bucket b : buckets) updateables.add((Updateable)b);
		...
		if(usingGUI) 
		{
			...
			for(MultiItemDoubleAuction m : economy.letterToWordMarkets) RenderWindow.addSolidRender(new SituatedMarketRender(m));
			for(MultiItemDoubleAuction m : economy.letterToBucketMarkets) RenderWindow.addSolidRender(new SituatedMarketRender(m));
			for(MultiItemDoubleAuction m : economy.transportationMarkets) RenderWindow.addSolidRender(new SituatedMarketRender(m));
			for(MultiItemDoubleAuction m : economy.storageMarkets) RenderWindow.addSolidRender(new SituatedMarketRender(m));
