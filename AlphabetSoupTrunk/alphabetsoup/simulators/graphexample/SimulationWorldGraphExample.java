...
public class SimulationWorldGraphExample extends SimulationWorld {
	...
	public SimulationWorldGraphExample() {
		...
		String window_size[] = params.getProperty("window_size").split("x"); //GET WIDTH AND HEIGHT
		...
		// UNLIKE SIMPLE EXAMPLE, IT USE BucketbotDriver BY ASSIGNING waypointGraph OBJECT TO STATIC FIELD waypointGraph 
		...
		// ASSIGNING MANAGER TO BUCKET BOT
		for(Bucketbot r : bucketbots) ((BucketbotDriver)r).manager = bucketbotManager;
	...
	public static void main(String[] args) 
	{
		...
		{
			RenderWindow.mainLoop(simulationWorld, ((SimulationWorldGraphExample)simulationWorld).simulationDuration);
			RenderWindow.destroyUserInterface();
		}
		else simulationWorld.update( ((SimulationWorldGraphExample)simulationWorld).simulationDuration);
